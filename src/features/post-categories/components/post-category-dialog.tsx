...
interface PostCategoryDialogProps {
  ...
  onSubmit: (data: CreatePostCategoryInput) => void;
  defaultValues?: Partial<CreatePostCategoryInput & { id: string }>;
  isLoading?: boolean;
}
...
export function PostCategoryDialog({
  open,
  onOpenChange,
  onSubmit,
  defaultValues,
  ...
  const form = useForm<CreatePostCategoryInput>({
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="post-cat-name">Tên danh mục</Label>
            <Input
              id="post-cat-name"
              placeholder="e.g. Tin tức"
              {...form.register("name")}
            />
          ...
          <div className="space-y-2">
            <Label htmlFor="post-cat-slug">Đường dẫn (Slug)</Label>
            <Input
              id="post-cat-slug"
              placeholder="e.g. tin-tuc"
              {...form.register("slug")}
            />
          ...
          <div className="space-y-2">
            <Label htmlFor="post-cat-desc">Mô tả</Label>
            <Textarea
              id="post-cat-desc"
